          ...
          <form id="frmSaveUser">
              ...
              <div class="form-group mb-2">
                  ...
                  <div class="form-check">
                      <input type="checkbox" class="form-check-input" name="permissions[]" value="add" id="perm-add">
                      <label class="form-check-label" for="perm-add">Add</label>
                  </div>
                  <div class="form-check">
                      <input type="checkbox" class="form-check-input" name="permissions[]" value="edit" id="perm-edit">
                      <label class="form-check-label" for="perm-edit">Edit</label>
                  </div>
                  <div class="form-check">
                      <input type="checkbox" class="form-check-input" name="permissions[]" value="delete" id="perm-delete">
  ...
  <script>
    $(document).ready(function() {
      ...
      $(document).on('click', '.btn-show', function() {
        ...
        $('#frmSaveUser')[0].reset();
        $('#userId').val('');
        $('#frmSaveUser input[name="permissions[]"]').prop('checked', false);
